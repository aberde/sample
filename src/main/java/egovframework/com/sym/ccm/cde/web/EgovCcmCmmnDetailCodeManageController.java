	...
	private DefaultBeanValidator beanValidator;
	   ...
	   /**
		...
		public String selectCmmnDetailCodeList (@ModelAttribute("loginVO") LoginVO loginVO, @ModelAttribute("searchVO") CmmnDetailCodeVO searchVO
				, ModelMap model, @RequestParam Map<String, String> paramMap
				) throws Exception {
	        ...
	        // 타일 값.(mainTiles: 메인, defaultTiles: 기본, manageTiles: 관리자)
	        String tiles = paramMap.get("tiles");
	        
	        return "egovframework/com/sym/ccm/cde/EgovCcmCmmnDetailCodeList" + (EgovStringUtil.isEmpty(tiles) ? "" : "." + tiles);
		}
