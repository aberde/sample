...
public class LoginController {
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/cm/login/login.do")
	public String login(@ModelAttribute("loginVO") LoginVO loginVO, HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
