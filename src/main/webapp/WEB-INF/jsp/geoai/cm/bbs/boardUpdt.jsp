<%
 /**
  * @Class Name : boardUpdt.jsp
  * @Description : boardUpdt 화면
...
<%@ taglib prefix="validator" uri="http://www.springmodules.org/tags/commons-validator" %>
    ...
    <div class="mask">
        <div class="popup evaluation">
            <header>
                <h3><c:out value="${boardMasterVO.bbsNm}"/> 수정</h3>
                <div class="box_r">
            ...
            <form:form commandName="boardVO" id="inputForm" name="inputForm" method="post" enctype="multipart/form-data">
                ...
                <input name="nttId" type="hidden" value="${boardVO.nttId}">
        ...
        <script type="text/javascript">
             ...
             ******************************************************** */
            function fnUpdate() {
                $("#inputForm").attr("action", "<c:url value='/cm/bbs/updateBoard.do'/>");
                $("#inputForm").submit();
            }
            /* ********************************************************
             * 삭제처리
